class Labels {
  ...
  static const String enterYourRegisteredEmail = "Enter your registered email below to receive password reset instruction";
  ...
  static const String joinASupportive = "JOIN A SUPPORTIVE\nCOMMUNITY";
