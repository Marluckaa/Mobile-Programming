...
class MeditateScreen extends StatefulWidget {
  ...
  @override
  State<MeditateScreen> createState() => MeditateScreenState();
}

class MeditateScreenState extends State<MeditateScreen> {
  int selectIndex = 0;
  List catArr = [
  ...
  List dataArr = [
    ...
    {"image": "img/medi2.png", "title": "Anxiet Release"},
    {"image": "img/medi4.png", "title": "Reduce Anxiet"},
    {"image": "img/medi3.png", "title": "Happiness"},
  ];
  @override
